        ...
        <main className="flex flex-col items-center justify-center z-10 text-black">
            ...
            <div className="w-full flex flex-col items-center px-4 lg:px-12 2xl:px-20 lg:gap-12 bg-white">
                ...
                <div className="flex md:flex-row items-center justify-center gap-8 select-none max-w-[1000px] w-full">
                    {/* <div className="swiper swiper-initialized swiper-horizontal flex justify-center items-center justify-items-center swiper-backface-hidden">
                        <div
                            className="swiper-wrapper"
                            style={{
                                transitionDuration: "300ms",
                                transform: "translate3d(-384.5px, 0px, 0px)"
                            }}
                        >
                            <div
                                className="swiper-slide flex justify-center !w-40 h-40 p-4"
                            ...
                            <div
                                className="swiper-slide swiper-slide-prev flex justify-center !w-40 h-40 p-4"
                            ...
                            <div
                                className="swiper-slide swiper-slide-active flex justify-center !w-40 h-40 p-4"
                            ...
                            <div
                                className="swiper-slide swiper-slide-next flex justify-center !w-40 h-40 p-4"
