...
export default function UseFourthsect() {
    return (
        <main className="flex flex-col items-center justify-center lg:pt-20 lg:px-24 z-10 bg-[#F0F0F5] text-[#15202A] overflow-visible">
            <div className="absolute bottom-0 left-0 right-0 bg-white h-52" />
            <div className="w-full flex flex-col px-4 lg:px-12 2xl:px-20 lg:gap-12 bg-white py-12 rounded-lg border border-[#CECECE66] z-10 ">
                <div className="relative">
                    <h1 className="relative text-[#0B0A2C] font-bold text-[40px] leading-[40px] tracking-[-0.5px] lg:text-[40px] lg:leading-[46px] lg:tracking-[-0.8px] z-10">
                        Remittix x Lewis Graves
                    </h1>
                    <div className="absolute w-20 h-4 bg-yellow bottom-0 left-8" />
                </div>
                        ...
                        <div className="flex flex-col gap-4">
                            <div className="grid md:grid-cols-2 gap-4">
                                ...
                                <div className="flex flex-col relative max-w-[335px] p-8 bg-[#040F19] rounded-lg bg-[url(/images/featurecard.png)] bg-cover">
                                    ...
                                    <span className="text-white text-[17.27px] font-normal mt-2 w-[240px]">
                                        Cross-border transfers come with a flat fee—no extra charges for
                                        FX, wires, or hidden costs. What you send is exactly what they
                                        receive.
                                    </span>
                                    <div className="absolute bottom-4 right-4">
                                        <svg
                            ...
                            <div className="flex flex-col-reverse md:grid md:grid-cols-2 gap-4">
                                ...
                                <div className="flex flex-col relative max-w-[335px] p-8 bg-[#F1F1F6] rounded-lg">
                                    ...
                                    <span className="text-[#040F19] text-[17.27px] font-normal mt-4 w-[240px]">
                                        Crypto is received instantly, and fiat is sent via local payment
                                        networks, ensuring same-day processing.
                                    </span>
                                    <div className="absolute bottom-4 right-4">
                                        <svg
                                            width={38}
                        ...
                        <div className="relative flex flex-col items-start justify-center bg-[#F9FF3859] min-h-[340px]  py-4 px-11 lg:px-14 gap-8">
                            <div className="relative flex flex-col gap-2 items-start">
                                ...
                                <span className="max-w-[150px] lg:max-w-[300px] z-10 text-[10px] leading-[9px] lg:text-[15px] lg:leading-[20.5px] lg:tracking-[-0.25px]">
                                    My client doesn't usually pay in crypto, so sharing a Pay.so link
                                    with them made life much easier. They were able to pay with
                                    confidence, and I&nbsp;received my funds instantly to my MetaMask
                                    wallet which I&nbsp;immediately cashed out to Binance with no
                                    extra fee.
                                </span>
                                <Image
                                    src={RightBracket}
